...
/**
 *  initialise the variable number to 10. 
 * Increment the variable number by 5.
 * console log the variable number.
 * write a single line comment with the answer.
*/ 
...
/**
 * Using camelCase, initialise the variable `first door` to the value of 1.
 * initialise the variable `second door` to the value of 5.
 * initialise total to the average of `first door`, and `second door`.
 * console log the total, and write a single line comment with the answer.
*/

var firstDoor = 1;
var secondDoor = 5;
var total = (firstDoor + secondDoor)/2;
console.log(total); //3

// Question 14 - write your own averaging question + answer

/**
 * Using camelCase, initialise the variable `Class One` to the value of 55.
 * initialise the variable `Class Two` to the value of 1.
 * initialise the variable `Class Three` to the value of 10.
 * initialise total to the average of `Class One`, `Class Two`, and `Class Three`.
 * console log the total, and write a single line comment with the answer.
 */
 var classOne = 55;
 var classTwo = 1;
 var classThree = 10;
 var total = (classOne + classTwo + classThree)/3;
